/*
***********************************************************************
* box2d.h:  Rectangular (undirected) bounding box in 2-D
*                where the x/y axes are respectively Forward/Left,
*               as opposed to what happens in
*               euler_angles_zxy.h (Right/Forward).
